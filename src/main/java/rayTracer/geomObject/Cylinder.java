...
public class Cylinder extends RTObject {
    ...
    public Cylinder(Vec3f center1, Vec3f center2, float diameter, Material material) {
        setCenter1(center1);
        setCenter2(center2);
    ...
    @Override
    public float rayIntersection(Vec3f p, Vec3f v) {
        ...
        if (D >= 0f) {
            ...
            distancesIndex = getDistancesIndex(p, v, vA, distances, distancesIndex, t1);
            distancesIndex = getDistancesIndex(p, v, vA, distances, distancesIndex, t2);
        }
    ...
    private int getDistancesIndex(Vec3f p, Vec3f v, Vec3f vA, float[] distances, int distancesIndex, float t1) {
        if (t1 > 0) {
